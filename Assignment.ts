...
let personal_name:string="Salman Qamar";
...
let array:string []= ["Salman","Faran","Aun","Haris","sharoon"]
...
let baby:string []=["Salman","Faran","Aun","Haris","sharoon"]
for (let i=0; i<baby.length; i++)
{
    console.log(`hello ${baby[i]} i hope you are doing well`);
}
...
let favoriteTransportation:string[]=["suzuki","Bantley"]
...
let guestList:string[]=["Haris","Salman","farrukh"]
...
let GuestList:string[]= ["Sami","Aun","farrukh","Aness"]
...
let GuestList1:string[]=["Salman","Haris","farrukh","Anwar"]
console.log("Guest List",GuestList1);
GuestList.unshift("Azam");
GuestList.splice(GuestList1.length/2,0,"kashif")
...
let DinnerGuestList:string[]=["Salman","Haris","Umair","Zafar"]
...
let country:string[]=["pakistan","Uganda","America","UK","Syria"]
...
let identification=[{Name:"Salman",city:"sahiwal",Province:"punjab",phone:"098765453"},
{Name:"Salman",city:"sahiwal",Province:"punjab",phone:"098765453"},
{Name:"Haris",city:"sahiwal",Province:"punjab",phone:"098765453"}
]
...
let intentionError:string[]=["Salman","Umair","Aun","Zafar"]
...
let current_user:string[]=["Salman","faran","Umair","Azeem","Anees"]
let new_user:string[]=["Salman","Kashif","Azeem","faran"]
...
function magician(magician_show:string[]=["Salman","Umair","Haris","Aun"]) {
